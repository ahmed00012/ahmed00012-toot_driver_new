...
import 'package:tood_driver_new/maps/map.dart';
import 'package:tood_driver_new/provider/accept_order_provider.dart';
import 'package:tood_driver_new/provider/distance_between_ru.dart';
import 'package:tood_driver_new/provider/distance_provider.dart';
import 'package:tood_driver_new/provider/new_order_provider.dart';
import 'package:tood_driver_new/provider/status_provider.dart';
...
import 'package:tood_driver_new/screens/order_details/order_details_screen.dart';
import 'package:tood_driver_new/servise/api_exceptions.dart';
import 'package:tood_driver_new/servise/api_location.dart';
                        ...
                        newProvider.order?.data?.length == 0
                            ? Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Lottie.asset(
                                      "assets/images/82138-order-delivered.json",
                                      height: 270,
                                      //   width: 300,
                                    ),
                                    SizedBox(
                                                            ...
                                                            builder: (buildContext,
                                                                ...
                                                                ChangeNotifierProvider<
                                                                    ...
                                                                    child: Consumer<DistanceCRProvider>(
                                                                        builder: (buildContext, disCRProvider, _) => Card(
                                                                              elevation: 3,
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        GestureDetector(
                                                                                          onTap: () {
                                                                                            print(lat);
                                                                                            MapUtils.openMap(double.parse(newProvider.order!.data![index].cart!.vendor!.lat!), double.parse(newProvider.order!.data![index].cart!.vendor!.long!));
                                                                                          },
                                                                                          child: Column(
                                                                                            children: [
                                                                                              Container(
                                                                                        ...
                                                                                        GestureDetector(
                                                                                          onTap: () {
                                                                                            MapUtils.openMap(double.parse(newProvider.order!.data![index].cart!.address!.lat!), double.parse(newProvider.order!.data![index].cart!.address!.lng!));
                                                                                          },
                                                                                          child: Column(
                                                                                            children: [
                                                                                              Container(
