...
import 'package:tood_driver_new/provider/open_order_provider.dart';
                        ...
                        : Column(children: [
                            Expanded(
                              ...
                              child: ListView.builder(
                                  itemCount:
                                      openProvider.order!.data?.length ?? 0,
                                  itemBuilder:
                                      (context, index) =>
                                          ChangeNotifierProvider<
                                                  DistanceProvider>(
                                              create: (_) => DistanceProvider(openProvider
                                                  .order!.data![index]),
                                                                  ...
                                                                  (buildContext,
                                                                      ...
                                                                      Card(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              padding: const EdgeInsets.only(left: 12.0, right: 12.0, top: 12, bottom: 8),
                                                                              child: Text(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  GestureDetector(
                                                                                    onTap: () {
                                                                                      print(lat);
                                                                                      MapUtils.openMap(double.parse(openProvider.order!.data![index].cart!.vendor!.lat!), double.parse(openProvider.order!.data![index].cart!.vendor!.long!));
                                                                                    },
                                                                                    child: Column(
                                                                                      children: [
                                                                                        Container(
                                                                                  ...
                                                                                  GestureDetector(
                                                                                    onTap: () {
                                                                                      MapUtils.openMap(double.parse(openProvider.order!.data![index].cart!.address!.lat!), double.parse(openProvider.order!.data![index].cart!.address!.lng!));
                                                                                    },
                                                                                    child: Column(
                                                                                      children: [
                                                                                        Container(
                                                                                ...
                                                                                children: [
                                                                                  GestureDetector(
                                                                                    onTap: () {
                                                                                      ...
                                                                                      _showRatingDialog(context, openProvider.order!.data![index].id);
                                                                                    },
                                                                                    child: Container(
                                                                                      width: 155,
                                                                                      height: 40,
