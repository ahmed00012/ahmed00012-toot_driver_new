...
import 'package:tood_driver_new/provider/order_details_provider.dart';
                  ...
                  ? SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          detailsProvider.order.orders!.cart!.address2 == null
                              ? Container()
                              : Container(
                                  width: double.infinity,
                                  padding: EdgeInsets.only(
                          ...
                          detailsProvider.order.orders!.cart!.district == null
                              ? Container()
                              : Container(
                                  width: double.infinity,
                                  padding: EdgeInsets.only(
                          ...
                          detailsProvider.order.orders!.identityNo.toString() ==
                                  "null"
                              ? Container()
                              : Container(
                                  width: double.infinity,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        detailsProvider.order.orders!.identityNo
                                            .toString(),
                                        style: TextStyle(
                                            fontSize: 18,
                                            color: kColorPrimary,
