...
import 'package:tood_driver_new/provider/notificationProvider.dart';
                            ...
                            child: GestureDetector(
                              onTap: () {
                                helpNavigateTo(
                                    context,
                                    NotificatinDetails(
                                        data: notifProvider.notification
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        notifProvider.notification
                                            .notifications!.data[index].title,
                                        style: TextStyle(
                                            fontSize: 18, color: kColorAccent),
                                      ),
                                    ),
                                    Padding(
