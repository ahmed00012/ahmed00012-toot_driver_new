...
class Vendor {
  ...
  Vendor.fromJson(Map<String, dynamic> json) {
    ...
    ordermethod = List.from(json['ordermethod'])
        .map((e) => Ordermethod.fromJson(e))
        .toList();
    vendordeliverycharges = List.from(json['vendordeliverycharges'])
        .map((e) => Vendordeliverycharges.fromJson(e))
        .toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['vendordeliverycharges'] =
        vendordeliverycharges!.map((e) => e.toJson()).toList();
