...
class Orders {
  ...
  factory Orders.fromJson(Map<String, dynamic> json) => Orders(
        ...
        identityNo: json["identity_number"].toString(),
      );
...
class Vendordeliverycharge {
  ...
  factory Vendordeliverycharge.fromJson(Map<String, dynamic> json) =>
      Vendordeliverycharge(
        id: json["id"],
        vendorId: json["vendor_id"],
        area: json["area"],
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        weight: json["weight"],
        cartitemaddon: json["cartitemaddon"] == null
            ? null
            : List<Cartitemaddon>.from(
                json["cartitemaddon"].map((x) => Cartitemaddon.fromJson(x))),
        cartitemoption: json["cartitemoption"] == null
            ? null
